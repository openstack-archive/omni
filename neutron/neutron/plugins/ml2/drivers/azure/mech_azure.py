...
from neutron.common.azure import config as azure_conf
...
class AzureMechanismDriver(api.MechanismDriver):
    ...
    def delete_network_postcommit(self, context):
        ...
        utils.delete_network(net_svc, conf.resource_group, name)
    ...
    def create_subnet_precommit(self, context):
        ...
        if self.is_private_network(cidr):
            try:
                utils.get_network(net_svc, conf.resource_group, network_name)
                ...
                utils.create_network(net_svc, conf.resource_group,
                                     network_name, body)
            utils.create_subnet(net_svc, conf.resource_group, network_name,
    ...
    def delete_subnet_precommit(self, context):
        ...
        if self.is_private_network(cidr):
            name = self._azure_subnet_name(context)
            network_name = self._azure_subnet_network_name(context)
            utils.delete_subnet(net_svc, conf.resource_group, network_name,
                                name)
