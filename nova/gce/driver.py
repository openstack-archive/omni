...
class GCEDriver(driver.ComputeDriver):
    ...
    def list_instances(self):
        ...
        for instance in all_instances:
            ...
            instance_ids.append(openstack_id)
    ...
    def suspend(self, context, instance):
        ...
        :param instance: nova.objects.instance.Instance
        """
        LOG.info("Suspending instance")
        self.power_off(instance)

    def resume(self, context, instance, network_info, block_device_info=None):
        """
        Since GCE doesn't support suspend and we cannot save system state,
        we've implemented the closest functionality which is to power on the
        instance.
        :param instance: nova.objects.instance.Instance
        """
        LOG.info("Resuming instance")
    ...
    def get_info(self, instance):
        ...
        p_state = GCE_STATE_MAP[gce_instance['status']]
    ...
    def get_diagnostics(self, instance):
        """Return data abouy VM diagnostics."""
        # Fake diagnostics
        return {
