...
class AzureDriver(driver.ComputeDriver):
    ...
    def _get_network_profile(self, network_info):
        ...
        for net_info in network_info:
            ...
            nic = azutils.get_nic(self.network_client, drv_conf.resource_group,
                                  nic_name)
            network_profile['network_interfaces'].append({'id': nic.id})
        return network_profile

    def _get_storage_profile(self, instance):
        LOG.info("Instance metadata: %s" % instance.system_metadata)
    ...
    def spawn(self,
        ...
        azutils.create_or_update_instance(self.compute_client,
    ...
    def reboot(self,
        ...
        azutils.restart_instance(self.compute_client, drv_conf.resource_group,
                                 azure_name)
    ...
    def power_off(self, instance, timeout=0, retry_interval=0):
        ...
        """
        azure_name = self._get_omni_name_from_instance(instance)
        azutils.stop_instance(self.compute_client, drv_conf.resource_group,
                              azure_name)

    def power_on(self, context, instance, network_info, block_device_info):
        """Power on the specified instance."""
        azure_name = self._get_omni_name_from_instance(instance)
        azutils.start_instance(self.compute_client, drv_conf.resource_group,
                               azure_name)
    ...
    def get_info(self, instance):
        ...
        azure_name = self._get_omni_name_from_instance(instance)
        az_instance = azutils.get_instance(self.compute_client,
                                           drv_conf.resource_group, azure_name)
